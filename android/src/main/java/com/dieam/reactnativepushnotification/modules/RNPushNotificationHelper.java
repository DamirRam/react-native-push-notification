                ...
                for (int i = 0; i < actionsArray.length(); i++) {
                    ...
                    if(action.equals("replyInput")){
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            notification.addAction(new NotificationCompat.Action.Builder(icon, buttonTitle, pendingActionIntent).build());
                        } else {
                            notification.addAction(icon, buttonTitle, pendingActionIntent);
                        }
                    }
                }
